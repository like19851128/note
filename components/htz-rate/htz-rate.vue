<template>
	<view class="htz-rate-main">
		<template v-for="(item,index) in count">
			<image @click="checkItem((index+1))" class="htz-rate-image" :key="index" :style="{'width':size+'rpx','height':size+'rpx','margin-right':gutter+'rpx'}"
...
<script>
	export default {
		...
		data() {
			return {
				ImgData: ['../../static/img/htz-rate/rate1_0.png', '../../static/img/htz-rate/rate2_0.png',
					'../../static/img/htz-rate/rate3_0.png', '../../static/img/htz-rate/rate4_0.png', '../../static/img/htz-rate/rate5_0.png',
					'../../static/img/htz-rate/rate6_0.png'
				],
				defImgSrc: '',
				selImgSrc: '',
				checkedVal: 0,
